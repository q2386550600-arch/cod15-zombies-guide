...
try:
 with sync_playwright() as p:
  ...
  page.evaluate('GuideDebug.goMap("bo2_origins")');page.click('#start');page.evaluate('GuideDebug.openSourceSection("little-lost-girl-15")');assert page.locator('.completeText li').count()==4;page.screenshot(path=str(OUT/'g-strike-details.png'));page.click('#readerCurrent');page.evaluate('GuideDebug.openDetailIndex()');page.locator('.detailJump').nth(5).click();page.screenshot(path=str(OUT/'micro-step.png'));page.click('#backOverview')
